...
You have global `list` of pollutants given by function `list_polluants_values()`. By default, parameters are set to NULL, you can initialize all parameters with value or customize parameters.
...
```{r edit pollutants}
# editing
edit_param_pollutants <- list_polluants_values(multi_values = 0.3)[1:3]
